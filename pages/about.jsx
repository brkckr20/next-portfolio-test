...
export default function Portfolio() {
    return (
        <div>
            ...
            <div className='bg-white px-5 md:px-[90px] py-[40px]'>
                <div className='grid grid-cols-2'>
                    <div>
                        ...
                        <div className='border-l border-gray-500 '>
                            <div className='flex w-full mt-3 md:mt-10 about-list relative items-center'>
                                <div className='ml-2 md:ml-10 bg-tertiaryColor md:mr-10 px-4 py-1 text-xs md:text-base rounded-3xl'>
                                    1998 - 2006
                                </div>
                    ...
                    <div>
                        <h1 className='font-semibold text-xl md:ml-0 ml-2'>Experience</h1>
