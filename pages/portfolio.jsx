    ...
    return (
        <div>
            ...
            <div className='w-full bg-mainBg px-5 md:px-[90px] py-[40px] min-h-screen'>
                <div className='mb-10'>
                    <h2 className='bg-secondaryBg inline-flex items-center px-4 py-2 mb-3 text-xs'>Home <MdOutlineKeyboardArrowRight size={20} className="mx-6" /> Creative Portfolio</h2>
                    <h2 className='text-[30px] font-bold tracking-tight'>Portfolio</h2>
                </div>
                <div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.img
                                        ...
                                        width="100%"
                                    />
                                    <motion.h1 className='absolute z-10 left-4 -bottom-5 group-hover:bottom-2 duration-200'>Lorem</motion.h1>
                                </motion.a>
